...
@Schema(name = "AttendanceResponse", description = "Response containing attendance details")
public record AttendanceResponse(

    @Schema(description = "The identifier of the record", example = "1")
    Long id,
    ...
    String meetingId,
    @Schema(description = "The status", example = "true")
    Boolean status,
